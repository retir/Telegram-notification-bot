...
class RedBlackTree:
    ...
    def insert(self, label) -> "RedBlackTree":
    ...
    def remove(self, label) -> "RedBlackTree":
    ...
    def search(self, label) -> "RedBlackTree":
...
# rb = RedBlackTree()
# rb = rb.insert(SomeClass(10))
# rb = rb.insert(SomeClass(5))
# rb = rb.insert(SomeClass(7))
#
# for tree in rb.inorder_traverse():
#     print(tree.numb)
# print(rb.get_min() is None)
